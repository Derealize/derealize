...
const spacingModel: SpacingModel = {
  ...
  widthPropertys: computed(
    ...
    (propertys, values) => {
      console.log(
        'widthPropertys',
        propertys.filter(({ classname }) => values.includes(classname)),
      )
      return propertys.filter(({ classname }) => values.includes(classname))
    },
  ),
  ...
  minWidthPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.minWidthValues],
  ...
  maxWidthPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.maxWidthValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
  ...
  minHeightPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.minHeightValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
  ...
  maxHeightPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.maxHeightValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
  ...
  marginPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.marginValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
  ...
  marginYPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.marginYValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
  ...
  marginXPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.marginXValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
  ...
  marginTopPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.marginTopValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
  ...
  marginBottomPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.marginBottomValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
  ...
  marginLeftPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.marginLeftValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
  ...
  marginRightPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.marginRightValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
  ...
  paddingPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.paddingValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
  ...
  paddingYPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.paddingYValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
  ...
  paddingXPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.paddingXValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
  ...
  paddingTopPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.paddingTopValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
  ...
  paddingBottomPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.paddingBottomValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
  ...
  paddingLeftPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.paddingLeftValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
  ...
  paddingRightPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.paddingRightValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
  ...
  spaceYPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.spaceYValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
  ...
  spaceXPropertys: computed(
    [(state, storeState) => storeState.element.activePropertys, (state) => state.spaceXValues],
    (propertys, values) => propertys.filter(({ classname }) => values.includes(classname)),
  ),
