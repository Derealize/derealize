...
import { AlignContentValues } from '../../../models/controlles/flex'
...
const AlignContent: React.FC<Props> = ({ already }: Props): JSX.Element => {
  ...
  const propertys = useStoreState<Array<Property>>((state) => state.flex.alignContentPropertys)
